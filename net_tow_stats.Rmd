...
stacked_plot <- ggplot(filtered_data, aes(x = cruise_id, y = total_ind_m3)) +
  geom_bar(stat = "identity", alpha = 0.8, width = 0.15) +
  labs(title = "Total Individuals per Cubic Meter at Site 57 (64 um)",
       x = "Cruise ID",
