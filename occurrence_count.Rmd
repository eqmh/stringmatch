...
spp_colors_zoopl <- c("#551F00FF", "#889D35FF", "#DF7700FF", "#F5B642FF","#FFF179FF","#C3F4F6FF", "#6AD5E8FF", "#32B2DAFF")
spp_colors_phyto <- c("#42511AFF", "#889D35FF", "#D3D175FF", "#B50200FF","#DA6C41FF","#7C6E66FF", "#BCAFA6FF")

# Step 3: Create the box plot
  season_boxplot <- ggplot(summary_selected, aes(x = season, y = species_concentration)) +
    geom_boxplot(fill = spp_colors_phyto[2], notch = TRUE) +
...
spp_concentration$X8.day.seascapes <- factor(spp_concentration$X8.day.seascapes, levels = c("3", "13", "15","21","27"))
...
avg_concentration_per_class$X8.day.seascapes <- factor(avg_concentration_per_class$X8.day.seascapes, levels = c("3", "13", "15","21","27"))

seascape_labels = c("TST", "SGMI", "TS", "WBHN", "HE")
...
font_size = 22
spp_labels_zoopl <- c("Rhizaria spp", "Chaetognaths", "Copepods", "Echinorderms", "Gelatinuos", "Larvaceans", "Polychaetes", "Pteropods")
spp_labels_phyto = c("Neoceratium spp", "Chaetoceros spp", "Chain diatoms", "Skeletonema spp", "Guinardia striata", "Neocalyptrella spp", "Trichodesmium spp")
spp_colors_zoopl <- c("#551F00FF", "#889D35FF", "#DF7700FF", "#F5B642FF","#FFF179FF","#C3F4F6FF", "#6AD5E8FF", "#32B2DAFF")
spp_colors_phyto <- c("#42511AFF", "#889D35FF", "#D3D175FF", "#B50200FF","#DA6C41FF","#7C6E66FF", "#BCAFA6FF")
...
ggsave("abund_phyto.svg", plot = avg_stackplot, width = 14, height = 8, device = "svg")
...
ggsave("abund_phyto_percent.svg", plot = avg_percent_stackplot, width = 14, height = 8, device = "svg")
...
df_filtered$X8.day.seascapes <- factor(df_filtered$X8.day.seascapes, levels = c("3", "13", "15","21","27"))
...
custom_colors <- c("3" = "#2A3F6E", "13" = "#3E92E0", "15" = "#61BEA4", "21" = "#FFB651FF", "27" = "#D85A44FF")
