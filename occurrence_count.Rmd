...
for (i in 1:(length(dt_list))) {
  ...
  gui_subset <- subset(class.Guinardia, date >= dt_list[i] & date < dt_list[i+1])
...
df_subset <- df_filtered[ , c(20, 23, 26, 28, 32, 35, 36, 37, 38, 39)] # subsets taxa when using dates
...
filt_df <- taxa_meta[1:82, ]
# pca <- prcomp(filt_df[, c(8,9,11,13)], scale. = TRUE) # for hydrography 
pca <- prcomp(filt_df[, c(20, 23, 26, 28, 32, 35, 36, 37, 38, 39)], scale. = TRUE)
