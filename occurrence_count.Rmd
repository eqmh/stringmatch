...
taxa_meta_concentration <- taxa_meta %>%
  ...
  select(Station, dec_lat, dec_lon, year, month, date, Avg.chl.a..ug.L., temp..degC., salinity,
         total_vol_sampled,
         Acantharea, 
         Copepods, 
         Echinoderms, 
...
taxa_meta_long <- taxa_meta_concentration %>%
  pivot_longer(cols = c(Acantharea, Copepods, Echinoderms, Jellies, Larvaceans, Chaetognaths, Polychaetes, Pteropods), names_to = "species", values_to = "species_concentration")

# Filter the data for Stations
# station_list <- c("WS","21/LK","MR","16","18","10","12","9.5","9","7","2",KW1","KW2","KW4")
# station_list <- c("68","65","64","60","58","57.3","57.2","57.1","57","56","55","54","53","51",
#                   "49","47","45","41","30","31","33")
# station_list <- c("CAL5","CAL4","CAL3","CAL2","CAL1","RP1","RP2","RP3","RP4","GP5","BG4","BG3",
#                   "BG2","BG1","BG6", "BG7")
# station_list <- c("V1","V2","V3","V4","V5","V6","V7","V8","V9","L1","L3","L5","L7","L9") 
station_list <- c("AMI9","AMI8","AMI7","AMI6","AMI5","AMI4","AMI3","AMI2","AMI1","TB1","TB2","TB3",
                  "TB4","TB5","TB10","CW4","CW3","CW2","CW1")
