...
# filter out rows with NA values in column "var1"
...
df_filtered[, 24:41] <- df_filtered[, 24:41] / rowSums(df_filtered[, 24:41])
...
df_subset <- df_filtered[ , c(20, 24, 27, 29, 33, 36, 37, 38, 39, 40, 41)]

# reshape the data to long format
df_long <- tidyr::gather(df_subset, key = "Species", value = "Abundance", -X8.day.seascapes)

# create the stackplot
ggplot(df_long, aes(x = X8.day.seascapes, y = Abundance, fill = Species)) +
