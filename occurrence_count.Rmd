...
seascape_labels = c("TST", "SGT", "TT", "TSU", "SGMI", "TS", "WBHN", "HE")
...
avg_stackplot <- ggplot(avg_concentration_per_class, aes(x = X8.day.seascapes, y = mean_concentration, fill = species)) +
  geom_bar(stat = "identity") +
  scale_fill_manual(values = c("#42511AFF", "#889D35FF", "#D3D175FF", "#B50200FF","#DA6C41FF","#7C6E66FF", "#BCAFA6FF"),
  labels = c("Neoceratium spp", "Chaetoceros spp", "Chain diatoms", "Skeletonema spp", "Guinardia striata", "Neocalyptrella spp", "Trichodesmium spp")) +
  # scale_fill_manual(values = c("#551F00FF", "#889D35FF", "#DF7700FF", "#F5B642FF","#FFF179FF","#C3F4F6FF", "#6AD5E8FF", "#32B2DAFF"), 
  # labels = c("Rhizaria spp", "Chaetognath", "Copepods", "Echinorderms", "Gelatinuos", "Larvaceans", "Polychaetes", "Pteropods")) +
